...
import { GradientBackground } from '../../components/GradientBackground';
import { loadAppliances, removeAppliance, saveAppliance } from '../../redux/slices/applianceSlice';
import { typography } from '../../styles/typography';
...
function Appliance({ navigation }) {
    ...
    const handleAddAppliance = () => {
        ...
        dispatch(saveAppliance(newAppliance));
    };
        ...
        Alert.alert(
            ...
            [
                { text: '취소', style: 'cancel' },
                {
                    text: '삭제',
                    style: 'destructive',
                    onPress: () => dispatch(removeAppliance(id)),
                },
            ]
        );
    };
...
const styles = StyleSheet.create({
    ...
    addCard: { backgroundColor: 'white', borderRadius: 15, padding: 20, marginBottom: 20 },
    addCardText: { textAlign: 'center', fontSize: 15, color: '#666666', marginBottom: 50 },
    addButton: { borderWidth: 1, borderColor: '#e0e0e0', borderRadius: 10, padding: 15 },
    buttonContent: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
    applianceList: { flex: 1 },
    ...
    applianceName: { textAlign: 'center', fontSize: 16, color: '#333333', marginVertical: 8 },
    applianceStatus: { textAlign: 'center', fontSize: 14 },
